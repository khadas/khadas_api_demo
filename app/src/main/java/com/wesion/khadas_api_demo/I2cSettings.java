		...
		public void onClick(View arg0) {
			...
			case R.id.i2c_read_btn:
				if(isInteger(i2c_text.getText().toString())) {
					i2c_read_tv.setText(String.valueOf(MainApp.getKhadasApi().i2c_read_byte_data(7,0x68, Integer.valueOf(i2c_text.getText().toString()))));
				}else{
			...
			case R.id.i2c_write_btn:
				if(isInteger(i2c_text.getText().toString())) {
					MainApp.getKhadasApi().i2c_write_byte_data(7,0x68, 0x10, Integer.valueOf(i2c_text.getText().toString()));
					i2c_write_tv.setText(String.valueOf(MainApp.getKhadasApi().i2c_read_byte_data(7,0x68, 0x10)));
				}else{
